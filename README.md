...
| [phxrpc](https://github.com/tencent-wechat/phxrpc) | 399 | A simple C++ based RPC framework. |
...
|Name|Star|Description|
|----|----|-----------|
| [weui](https://github.com/weui/weui) | 11254 | A UI library by WeChat official design team, includes the most useful widgets/modules in mobile web applications. |
...
|Name|Star|Description|
|----|----|-----------|
| [QMUI_Web](https://github.com/QMUI/QMUI_Web) | 507 | 腾讯 QMUI Web 前端框架 |
| [qmui-ios-codesnippets](https://github.com/QMUI/qmui-ios-codesnippets) | 132 | 用于Xcode使用的iOS通用代码片段，其中也包含若干专用于QMUI iOS框架的代码片段。 |
| [QMUI_Web_Desktop](https://github.com/QMUI/QMUI_Web_Desktop) | 55 | 基于 QMUI Web 的桌面 App，它可以管理基于 QMUI Web 进行开发的项目，通过 GUI 界面处理 QMUI Web 的服务开启/关闭，使框架的使用变得更加便捷，并提供了编译提醒，出错提醒，进程关闭提醒等额外的功能。 |
...
| [tencentopen.github.io](https://github.com/TencentOpen/tencentopen.github.io) | 70 | Tencent Open Source - 腾讯开源 |
| [TscanCode](https://github.com/TencentOpen/TscanCode) | 67 | TscanCode |
...
| [Rythem](https://github.com/AlloyTeam/Rythem) | 619 | a fiddler-like project using Qt |
| [AlloyFinger](https://github.com/AlloyTeam/AlloyFinger) | 509 | super tiny size multi-touch gestures library for the web. 　　　You can touch this → |
| [alloyteam.github.com](https://github.com/AlloyTeam/alloyteam.github.com) | 504 | 腾讯 AlloyTeam 开源项目官网 - 我们的愿景: 成为业界卓越的Web团队！ |
| [AlloyGameEngine](https://github.com/AlloyTeam/AlloyGameEngine) | 375 | made game making super easy |
| [Nuclear](https://github.com/AlloyTeam/Nuclear) | 355 | Some HTML + Scoped CSS + JS === Reusable Component |
...
| [AlloyTimer](https://github.com/AlloyTeam/AlloyTimer) | 94 | AlloyTimer定时器 - 番茄工作法的时间管理应用 |
| [AlloyTouch](https://github.com/AlloyTeam/AlloyTouch) | 89 | 60FPS的触摸运动 |
...
| [AlloyClip](https://github.com/AlloyTeam/AlloyClip) | 57 | A PC & Mobile Image Clip Kit based on AlloyImage |
| [SodaRender](https://github.com/AlloyTeam/SodaRender) | 47 | lite template render engine for JavaScript |
| [Abstract.js](https://github.com/AlloyTeam/Abstract.js) | 38 | Abstract.js is a web framework for fast development |
